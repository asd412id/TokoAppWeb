          ...
          <div class="col-sm-12 col-md-4">
            <div class="form-group mb-2">
              ...
              <div class="input-group date" id="reservationdate" data-target-input="nearest">
                ...
                <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" value="{{ old('tgl_transaksi')??$data->tgl_transaksi->format('d/m/Y') }}" name="tgl_transaksi"/>
              </div>
            </div>
            <div class="form-group mb-2">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="kode_transaksi" value="{{ old('kode_transaksi')??$data->kode_transaksi }}"/>
              </div>
            </div>
            <div class="form-group mb-2">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="nama_transaksi" value="{{ old('nama_transaksi')??$data->nama_transaksi }}"/>
              </div>
            </div>
          </div>
          <div class="col-sm-12 col-md-4">
              ...
              <div class="row">
                <div class="col-sm-8">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control currency" name="dibayar" id="dibayar" value="{{ old('dibayar')??$data->dibayar }}" autocomplete="off"/>
                  </div>
                </div>
                <div class="col-sm-4">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" name="diskon" class="form-control" id="diskon" value="{{ old('diskon')??$data->diskon }}" autocomplete="off"/>
                  </div>
                </div>
              </div>
            </div>
                ...
                <tbody id="list">
                  @if (count($data->penjualan))
                    @foreach ($data->penjualan as $key => $dp)
                      ...
                      <input type="hidden" name="id[]" value="{{ $dp->barang_id }}"/>
                      <td class="no">{{ $key+1 }}</td>
                      <td>{{ $dp->kode }}</td>
                      <td>{{ $dp->nama }}</td>
                      <td class="harga currency">{{ $dp->harga_jual }}</td>
                      <td width="100"><input type="number" max="{{ $dp->barangByKode->jumlah }}" name="jumlah[]" class="jumlah form-control" value="{{ $dp->jumlah }}"/></td>
